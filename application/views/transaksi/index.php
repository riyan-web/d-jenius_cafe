          ...
          <div class="row">
            <div class="col-lg-12">
              <h5 class='judul-transaksi'>
                <a href="<?= base_url('home') ?>"><i class="fa fa-home"> Home </i></a><i class='fa fa-angle-right fa-fw'></i><i class='fa fa-shopping-cart fa-fw'></i> Transaksi <i class='fa fa-angle-right fa-fw'></i> Penjualan
