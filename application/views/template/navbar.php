                                ...
                                <div class="main-menu  d-none d-lg-block">
                                    <nav>
                                        <ul id="navigation">
                                            ...
                                            <li><a <?php if(isset($tab3)) echo 'class="active"'; ?> href="#">Laporan <i class="ti-angle-down"></i></a>
                                                <ul class="submenu">
                                            ...
                                            <li><a <?php if(isset($tab4)) echo 'class="active"'; ?> href="<?=base_url('operasional')?>">Operasional</a></li>
                                        </ul>
                                    </nav>
                                </div>
                            </div>
